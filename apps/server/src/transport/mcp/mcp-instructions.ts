...
If you control the runtime and can export richer end-of-run context, declare client.capability as owned_runtime in start_session. Owned-runtime sessions may call submit_run_context after a task is completed or failed to distill higher-signal memory artifacts. Other clients should use submit_task_context for lighter post-task notes.
